...
pub fn parse_goes_filename(filename: &str) -> Option<GoesFileInfo> {
    // Extract satellite from _G18_ or _G19_
...
mod tests {
    ...
    fn test_extract_model_goes19() {
        ...
        assert_eq!(
            extract_model_from_filename("OR_ABI-L2-MCMIPC-M6C02_G19_s20241217180021.nc"),
            Some("goes19".to_string())
        );
        assert_eq!(
    ...
    #[test]
    fn test_parse_goes_filename_goes19() {
        // GOES timestamp format: YYYYDDDHHMMSS where DDD is day of year
        // Day 352 of 2024 = December 17, 2024
        let filename =
            "OR_ABI-L2-MCMIPC-M6C02_G19_s20243521800210_e20243521800210_c20243521800210.nc";
    ...
    fn test_parse_goes_filename_m3_scan_mode() {
        let filename =
            "OR_ABI-L2-MCMIPC-M3C02_G19_s20243521800210_e20243521800210_c20243521800210.nc";
        let info = parse_goes_filename(filename).expect("Should parse");
