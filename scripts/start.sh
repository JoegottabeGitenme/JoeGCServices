...
show_compose_status() {
    ...
    echo "  Web Dashboard: http://localhost:8000  (cd web && python3 server.py)"
    echo "  WMS API:       http://localhost:8080  (cargo run --bin wms-api)"
...
show_compose_access_info() {
    ...
    echo ""
    echo "Web Dashboard (Interactive Testing):"
    ...
    echo "  Cmd:  cd web && python3 server.py"
    echo ""
    echo "WMS API:"
    ...
    case "${1:-}" in
        ...
        --help|-h)
            ...
            echo ""
             ...
             echo ""
             echo "  2. In another terminal, start the WMS API:"
             echo "     cargo run --bin wms-api"
             echo ""
             ...
             echo ""
             echo "  4. Or test from command line:"
             echo "     curl 'http://localhost:8080/wms?SERVICE=WMS&REQUEST=GetCapabilities'"
             echo ""
