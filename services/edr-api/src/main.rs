...
async fn run_server(args: Args) {
    ...
    let app = Router::new()
        ...
        // Conformance
        .route("/edr/conformance", get(handlers::conformance::conformance_handler))
        
        // Collections
        .route("/edr/collections", get(handlers::collections::list_collections_handler))
        .route("/edr/collections/:collection_id", get(handlers::collections::get_collection_handler))
        
        // Instances
        .route("/edr/collections/:collection_id/instances", get(handlers::instances::list_instances_handler))
        .route("/edr/collections/:collection_id/instances/:instance_id", get(handlers::instances::get_instance_handler))
        
        // Position query
        .route("/edr/collections/:collection_id/position", get(handlers::position::position_handler))
        .route("/edr/collections/:collection_id/instances/:instance_id/position", get(handlers::position::instance_position_handler))
